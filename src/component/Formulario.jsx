  ...
  return (
    <div className="w-1/ lg:w-3/5">
        ...
        <form className="bg-white shadow-md rounded-lg py-10 px-5 mb-10">
          ...
          <input
            type="submit"
            className="bg-indigo-600 w-full p-3 text-white uppercase font-bold hover:bg-indigo-700 cursor-pointer transition-all transition-colors"
